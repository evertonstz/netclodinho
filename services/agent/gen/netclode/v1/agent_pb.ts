...
export const file_netclode_v1_agent: GenFile = /*@__PURE__*/
  fileDesc("", [file_netclode_v1_common, file_netclode_v1_events]);
...
export type AgentMessage = Message<"netclode.v1.AgentMessage"> & {
  ...
  message: {
     ...
     *
     * @generated from field: netclode.v1.AgentSnapshotResult snapshot_result = 7;
     */
    value: AgentSnapshotResult;
    case: "snapshotResult";
...
export type ControlPlaneMessage = Message<"netclode.v1.ControlPlaneMessage"> & {
  ...
  message: {
     ...
     * Snapshot operations
     *
     * @generated from field: netclode.v1.CreateSnapshotCommand create_snapshot = 8;
     */
    value: CreateSnapshotCommand;
    case: "createSnapshot";
  } | {
    /**
     * @generated from field: netclode.v1.RestoreSnapshotCommand restore_snapshot = 9;
     */
    value: RestoreSnapshotCommand;
 ...
 *
 * @generated from message netclode.v1.CreateSnapshotCommand
 */
export type CreateSnapshotCommand = Message<"netclode.v1.CreateSnapshotCommand"> & {
  /**
   * ID for correlating response
   *
   * @generated from field: string request_id = 1;
...
/**
 * Describes the message netclode.v1.CreateSnapshotCommand.
 * Use `create(CreateSnapshotCommandSchema)` to create a new message.
 */
export const CreateSnapshotCommandSchema: GenMessage<CreateSnapshotCommand> = /*@__PURE__*/
  messageDesc(file_netclode_v1_agent, 20);

/**
 * RestoreSnapshotCommand asks the agent to restore workspace from a snapshot.
 *
 * @generated from message netclode.v1.RestoreSnapshotCommand
 */
export type RestoreSnapshotCommand = Message<"netclode.v1.RestoreSnapshotCommand"> & {
  /**
   * ID for correlating response
   *
   * @generated from field: string request_id = 1;
...
/**
 * Describes the message netclode.v1.RestoreSnapshotCommand.
 * Use `create(RestoreSnapshotCommandSchema)` to create a new message.
 */
export const RestoreSnapshotCommandSchema: GenMessage<RestoreSnapshotCommand> = /*@__PURE__*/
  messageDesc(file_netclode_v1_agent, 21);

/**
 * AgentSnapshotResult contains the result of a snapshot operation.
 *
 * @generated from message netclode.v1.AgentSnapshotResult
 */
export type AgentSnapshotResult = Message<"netclode.v1.AgentSnapshotResult"> & {
  /**
   * Echoed from command
   *
   * @generated from field: string request_id = 1;
   ...
   *
   * Workspace size at snapshot time
   *
...
/**
 * Describes the message netclode.v1.AgentSnapshotResult.
 * Use `create(AgentSnapshotResultSchema)` to create a new message.
 */
export const AgentSnapshotResultSchema: GenMessage<AgentSnapshotResult> = /*@__PURE__*/
